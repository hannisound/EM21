...
sec_session_start(); // Sichere PHP Sitzung starten
...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'max_file_size' => 'Bild ist zu groß',
        'min_file_size' => 'Bild ist zu klein',
        'accept_file_types' => 'Dateityp ist nicht zulässig',
        'max_number_of_files' => 'Maximum number of files exceeded',
        'max_width' => 'Image exceeds maximum width',
        'min_width' => 'Image requires a minimum width',
        'max_height' => 'Image exceeds maximum height',
        'min_height' => 'Image requires a minimum height',
        'abort' => 'Der Upload wurde abgebrochen',
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/../../images/profilbild/',
            'upload_url' => $this->get_full_url().'/../../images/profilbild/',
    ...
    protected function generate_unique_filename($filename = "")
        {
            ...
            return $_SESSION['username'] . $extension;
        }
